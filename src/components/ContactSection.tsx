...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="bg-tamna py-24 overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 md:px-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-20">
          ...
          {/* Left — Phone mockup with Instagram */}
          <a
            href={IG_URL}
            target="_blank"
          ...
          >
            {/* Phone shell */}
            <div className="relative w-44 h-[340px] bg-tamna border-[3px] border-svetla/20 rounded-[2.5rem] shadow-2xl overflow-hidden transition-transform duration-300 group-hover:-translate-y-2">
              {/* Side buttons */}
                ...
                <div className="h-full flex flex-col">
                  ...
                  <div className="flex items-center justify-between px-3 py-2 border-b border-white/10">
                    <svg className="w-14 h-4 text-white" viewBox="0 0 80 20" fill="currentColor">
                      <text x="0" y="15" fontSize="13" fontFamily="'Playfair Display', serif" fontStyle="italic">Instagram</text>
                    </svg>
                  ...
                  {/* Mini photo grid */}
                  <div className="flex-1 grid grid-cols-3 gap-[1px] px-0">
                    {[
                  ...
                  <div className="flex justify-around items-center px-4 py-2 border-t border-white/10">
                    {['M5 3h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z', 'M21 21l-6-6m2-5a7 7 0 1 1-14 0 7 7 0 0 1 14 0', 'M12 5v14M5 12h14', 'M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2'].map((d, i) => (
                      <svg key={i} className="w-3 h-3 text-white/60" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                        <path d={d} />
                      </svg>
                    ))}
                  </div>
          ...
          {/* Center — Shimmer CTA text */}
          <div className="flex flex-col items-center gap-8 text-center">
            <p className="text-xs font-semibold tracking-[0.45em] text-svetla/30 uppercase">
              {t('subtitle')}
            </p>
            <h3 className="shimmer-text font-display text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight">
          ...
          >
            <div className="w-20 h-20 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg shadow-[#25D366]/25 transition-transform duration-300 group-hover:scale-110 group-hover:shadow-[#25D366]/50">
              {/* WhatsApp SVG icon */}
